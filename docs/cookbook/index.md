...
- **현업 보험계리 담당자** — 자기 상품을 fastcashflow 로 평가하려는
  실무 actuary
...
* - I
  - 기초 (Basics)
  - 상태 추적 없는 단순 상품. 사망 단독 / 진단 일시금. fastcashflow 의
    가장 빠른 경로 (fast_path).
* - II
  - Markov 상태기계
...
Part I → IV 의 순서는 **학습 곡선**입니다. 하지만 인덱스에서 자기 상품에
...
* - 8
  ...
  - assumptions.xlsx 의 매 시트 / 매 컬럼 자세히. 비프로그래머 진입점.
* - 9
