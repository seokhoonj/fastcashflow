...
위 "최소 작동 예제" / "자주 쓰는 변형" 의 예제는 모두 워크북 로더가
사망률 / 해지율을 함수로
...
**어느 단계에서 갈렸는지** 바로 보입니다. 자세한 사용은 분석 / 검증
파트의 [검증 패턴](../workflow/validation).
