...
- segment 마다 다른 **Model** 을 지정하는 `state_model` 열
...
* - `_DEFAULTS`
  - —
  - —
  - MORTALITY_STD / DISCOUNT_STD / state_model=ACTIVE_WAIVER / ra_confidence=0.75
* - (TERM_LIFE_A, FC)
  - LAPSE_TERM_FC
  - EXPENSE_TERM_FC
  - (defaults 상속)
...
- **사망률 · 할인율 · state_model 은 공통** — `_DEFAULTS` 에서 상속해 모든
