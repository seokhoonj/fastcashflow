...
그 안에 이익계약이 섞여 있을 수 있습니다(이 샘플 포트폴리오에도 음수 BEL
계약이 하나 들어 있습니다). 개별 계약을 보려면 합산 전 per-계약 배열
...
Reconciliation -- months 1-12
                               BEL                RA               CSM
Opening                -27,230,608         1,439,298        27,976,552
Future service                   0                 0                 0
Finance                   -863,557            42,666           831,844
Release                  6,152,645          -138,158        -2,525,582
Closing                -21,941,521         1,343,806        26,282,814
```
...
Insurance revenue   13,159,725   4,933,413   4,429,202   3,965,594   3,536,789
Service expense     10,496,337   2,528,900   2,291,588   2,059,217   1,836,202
Service result       2,663,389   2,404,514   2,137,613   1,906,377   1,700,588
Finance expense         10,953     315,040     763,183   1,054,089   1,358,082
CSM accretion          831,844     782,587     953,591     902,946     907,301
CSM release          2,525,582   2,279,573   2,022,512   1,801,799   1,606,778
```
