...
def test_annuity_frequency_payout_months():
    ...
    annuity = 2_000_000.0
    mp = ModelPoints.single(issue_age=60, benefits={"DEATH": 0.0},
                            calculation_methods={"DEATH": CalculationMethod.DEATH},
...
def test_measure_value_agree_under_frequency():
    ...
    mps = ModelPoints(
        ...
        benefits={"DEATH": rng.integers(10, 60, n) * 1_000_000.0},
        calculation_methods={"DEATH": CalculationMethod.DEATH},
...
def test_default_frequency_is_monthly():
    ...
    kw = dict(issue_age=45, benefits={"DEATH": 20_000_000.0}, premium=30_000.0,
              calculation_methods={"DEATH": CalculationMethod.DEATH},
...
def test_frequency_must_be_positive():
    ...
    with pytest.raises(ValueError, match="premium_frequency_months"):
        ModelPoints.single(issue_age=40, benefits={"DEATH": 1_000_000.0},
                           calculation_methods={"DEATH": CalculationMethod.DEATH},
                           premium=1_000.0, term_months=12,
