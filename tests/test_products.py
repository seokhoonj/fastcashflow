...
def test_pure_endowment():
    ...
    assert np.isclose(res.bel_path[0, 0], pv_maturity - pv_premiums)


def test_value_matches_measure_endowment():
    """measure() and measure() agree on endowment contracts."""
...
def test_value_matches_measure_annuity():
    """measure() and measure() agree on immediate-annuity contracts."""
