...
def test_measure_ul_margin_hand_calc():
    ...
    assert isinstance(m, fcf.GMMMeasurement)     # routed through the GMM path
...
def test_measure_ul_routing_changes_only_the_discount():
    ...
    assert isinstance(gmm, fcf.GMMMeasurement)   # GMM routing
    assert isinstance(vfa, fcf.VFAMeasurement)   # VFA routing
