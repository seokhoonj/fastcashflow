...
reinsurance-held measurement instead returns a :class:`_reinsurance.Report` --
...
def report(measurement) -> Report:
    ...
    :class:`_reinsurance.Report` (the mirror layout, IFRS 17 paragraphs 82 + 86),
...
@report.register
def _(measurement: _reinsurance.Measurement) -> _reinsurance.Report:
    _require_inception(measurement, "report()")
...
def _report_reinsurance(m: _reinsurance.Measurement) -> _reinsurance.Report:
    ...
    (the net cost or gain of the cover, paragraph 65) -- the same release-based build
